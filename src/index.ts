import { app, BrowserWindow, shell, session, autoUpdater, ipcMain, dialog } from "electron";
...
console.log(`EmuSAK ${app.getVersion()} on ${process.platform}`);
...
if (process.platform === "win32" && !process.argv.join("").includes("squirrel")) {
  ...
  log.transports.file.resolvePath = () => path.resolve(cacheDir, "main.log");
